...
/* 0x04
   ...
   27      R/W    keyscan_column_output_high_en   1'h0
   28      R/W    keyscan_pull_high_en            1'h1
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t keyscan_column_output_high_en: 1;
        uint32_t keyscan_pull_high_en: 1;
...
/* 0x08
   ...
   9:5     R      reserved_dummy08_9_5            5'h0
   10      R/W    keyscan_manual_sel              1'h1
   20:11   R/W    keyscan_fifo_filter_data        10'h0
   21      R/W    keyscan_fifo_data_filter_en     1'h0
   22      R/W    keyscan_manual_trigger          1'h0
   27:23   R      reserved_dummy08_27_23          5'h0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t keyscan_fifo_filter_data: 10;
...
/* 0x10
   17:0    R/W    keyscan_row_sel                 18'h0
   19:18   R      reserved_dummy10_19_18          2'h0
   24:20   R/W    keyscan_row_num                 5'h0
   31:25   R      reserved_dummy10_31_25          7'h0
*/
typedef union
{
    uint32_t d32;
    struct
    {
        uint32_t keyscan_row_sel: 18;
        const uint32_t reserved_1: 2;
        uint32_t keyscan_row_num: 5;
...
/* 0x14
   9:0     R      keyscan_fifo_entry              10'h0
   31:10   R      reserved_dummy14_31_10          22'h0
*/
typedef union
{
    uint32_t d32;
    struct
    {
        const uint32_t keyscan_fifo_entry: 10;
...
/* 0x1C
   ...
   7       W1C    keyscan_fifo_data_filter_st_clr 1'h0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t keyscan_fifo_data_filter_st_clr: 1;
...
/* 0x20
   ...
   3       R      keyscan_fifo_data_filter_status 1'h0
   10:4    R      keyscan_fifo_data_level         7'h0
   14:11   R      reserved_dummy20_14_11          4'h0
   15      R      keyscan_all_release_int_status  1'h0
   16      R      keyscan_fifo_notempty_int_status1'h0
...
typedef union
{
    ...
    struct
    {
        ...
        const uint32_t keyscan_fifo_data_filter_status: 1;
        const uint32_t keyscan_fifo_data_level: 7;
...
/* 0x30
   31:0    R      rtl_version                     32'h20241025
*/
typedef union
{
    uint32_t d32;
...
/* 0x38
   0       R/W    rap_mode                        1'h0
   1       WAC    task_manual                     1'h0
   31:2    R      reserved31_2                    30'h0
*/
typedef union
{
    uint32_t d32;
    ...
    {
        uint32_t rap_mode: 1;
        uint32_t task_manual: 1;
        const uint32_t reserved_0: 30;
    } b;
} KEYSCAN_TASK_CTRL_TypeDef;


/* 0x3C
   0       R/W    clk_qactive_man_data            1'h0
   1       R/W    clk_qactive_man_enable          1'h0
...
typedef union
{
    ...
    struct
    {
        uint32_t clk_qactive_man_data: 1;
        uint32_t clk_qactive_man_enable: 1;
        uint32_t pclk_qactive_man_data: 1;
        uint32_t pclk_qactive_man_enable: 1;
        const uint32_t reserved_0: 28;
    } b;
} KEYSCAN_QACTIVE_CTRL_TypeDef;


/* 0x40
   6:0     R/W    keyscan_fifo_th_level           7'h6c
   22:7    R      reserved_dummy40_22_7           16'h0
   29:23   R/W    keyscan_fifo_limit              7'h0
   31:30   R      reserved_dummy40_31_30          2'h0
*/
typedef union
{
    uint32_t d32;
    struct
    {
        uint32_t keyscan_fifo_th_level: 7;
        const uint32_t reserved_1: 16;
        uint32_t keyscan_fifo_limit: 7;
        const uint32_t reserved_0: 2;
    } b;
} KEYSCAN_CONFIG3_TypeDef;
