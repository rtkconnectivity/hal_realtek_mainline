...
LOG_MODULE_REGISTER(ppt_driver, PPT_DRIVER_LOG_LEVEL);
...
void ppt_notify_btmac(bool ppt_mode)
{
    ...
    lowerstack_SystemCall(6, ppt_mode, 0, 0);
}
...
{
    power_manager_master_initiate_wakeup(PM_SLAVE_PROPRIETARY, ((PM_UNIT_PROPRIETARY >> 2) & 0x3),
                                         PM_UNIT_PROPRIETARY);
