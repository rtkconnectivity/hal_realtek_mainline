...
LOG_MODULE_REGISTER(ppt_simple, PPT_DRIVER_LOG_LEVEL);
...
PPT_API_SECTION void ppt_psd_isr_handler_imp(void)
{
    ...
    ppt_ctx->fsm = PPT_FSM_STANDBY;
    APP_PRINT_INFO0("[ppt psd isr] set sync flag false here");
